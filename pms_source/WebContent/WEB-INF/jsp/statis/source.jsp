...
<head>
	...
	<script type="text/javascript">
		$(function(){
	 	   /** 导出excel功能 */
	    	$("#down").click(function(){
	    		window.location = "${ctx }/statis/downloadSource";
	    	})
	    });
...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		...
		<td class="main_locbg font2"><img src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：统计报表 &gt; 来源汇总</td>
	    ...
	    <td height="20">
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
		    <tr class="main_trbg_tit" align="center">
			  <td rowspan="2" colspan="2">项目渠道<br>(具体到分公司)</td>
			...
			<c:forEach items="${requestScope.statiss}" var="statis" varStatus="stat">
					<c:if test="${stat.index %4 == 0 }">
						<tr align="center" class="main_trbg">
						<td colspan="2">${statis.source}</td>
					</c:if>
					<td>${statis.count }</td>
					<td>${statis.sum }</td>
