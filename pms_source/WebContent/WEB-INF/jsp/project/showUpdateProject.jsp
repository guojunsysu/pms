...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td class="main_locbg font2"><img src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：项目管理&gt; 修改项目</td>
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${ctx}/project/updateProject" id="projectForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
	    ...
	    <td height="20">
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<tr align="center">
			  ...
			  <td class="main_trbg">
			  <input type="text" name="source" id="source" size="20" value="${project.source}">
			  </td>
			</tr>
			...
			<tr align="center">
			  ...
			  <td class="main_trbg">
			  <input type="text" name="manager" id="manager" size="20" value="${project.manager}">
			  </td>
			</tr>
			...
			<tr align="center">
			  ...
			  <td class="main_trbg">
			  <input type="text" name="status" id="status" size="20" value="${project.status}">
			  </td>
			</tr>
			...
			<tr align="center">
			  ...
			  <td class="main_trbg">
			  <input type="text" name="product" id="product" size="20" value="${project.product}">
			  </td>
			</tr>
			...
			<tr align="center">
			  ...
			  <td class="main_trbg">
			  <input type="text" name="projectname" id="projectname" size="20" value="${project.projectname}">
			  </td>
			</tr>
			...
			<tr align="center" height="5" style="height: 100px; ">
			  ...
			  <td class="main_trbg">
			  <textarea name="overview" id="overview" rows="5" cols="20">${project.overview}</textarea>
			  </td>
			</tr>
			...
			<tr align="center">
			  ...
			  <td class="main_trbg">
			  <input type="text" name="income_year" id="income_year" size="20" value="${project.income_year}">
			  </td>
			</tr>
			...
			<tr align="center">
			  ...
			  <td class="main_trbg">
			  <input type="text" name="time" id="time" size="20" value="${project.time}">
			  </td>
			</tr>
			...
			<tr align="center">
			  ...
			  <td class="main_trbg">
			  <input type="text" name="income" id="income" size="20" value="${project.income}">
			  </td>
			</tr>
			
			<tr align="center">
			  <td class="main_trbg_tit">广州年收入预测</td>
			  <td class="main_trbg">
			  <input type="text" name="income_gz" id="income_gz" size="20" value="${project.income_gz}">
			  </td>
			</tr>
			...
			<tr align="center">
			  ...
			  <td class="main_trbg">
			  <input type="text" name="increase_stock" id="increase_stock" size="20" value="${project.increase_stock}">
			  </td>
			</tr>
			...
			<tr align="center">
			  ...
			  <td class="main_trbg">
			  <input type="text" name="cost" id="cost" size="20" value="${project.cost}">
			  </td>
			</tr>
			...
			<tr align="center">
			  ...
			  <td class="main_trbg">
			  <input type="text" name="time_success" id="time_success" size="20" value="${project.time_success}">
			  </td>
			</tr>
			...
			<tr align="center">
			  ...
			  <td class="main_trbg">
			  <input type="text" name="time_tagged" id="time_tagged" size="20" value="${project.time_tagged}">
			  </td>
			</tr>
