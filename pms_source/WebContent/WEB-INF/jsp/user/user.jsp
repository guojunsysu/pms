		...
		$(function(){
	 	   ...
	 	   $("#delete").click(function(){
	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   $.ligerDialog.error("请选择一个需要删除的项目！");
	 		   }else{
	 			   /** 得到用户选中的所有的需要删除的ids */
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除项目",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
				    ...
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	...
					    	部门：<input type="text" name="department" value=${user.department }>
					    	组别：<input type="text" name="team" value=${user.team }>
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${ctx}/user/selectUser?pageIndex={0}&username=${user.username}&role=${user.role }&department=${user.department }&team=${user.team }"/>
	  </td></tr>
	</table>
