		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		...
		    		<tr>
		    			<td id="department" class="font3 fftd" style="display:none">部&nbsp;门：<input type="text" name="department" id="department1" size="20" value="${user.department }"/></td>
		    			<td id="team" class="font3 fftd" style="display:none">组&nbsp;别：<input type="text" name="team" id="team1" size="20" value="${user.team }"/></td>
		    		</tr>
